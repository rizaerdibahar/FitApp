...
class back_9 extends StatefulWidget {
  @override
  _back_9State createState() => _back_9State();
}

class _back_9State extends State<back_9> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Back1/Deadlifts.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Difficult but effective exercise to train your back.",
              ...
              Text(
                "   How to do it: Stand with your mid-foot under the barbell,bend over and grab the bar with a shoulder-width grip,bend your knees until your shins touch the bar,lift your chest up and straighten your lower back inhale and stand up with the weight.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
              ...
              Spacer(flex: 1),
              Text(
                "This exercise requires you to have barbell.",
                textAlign: TextAlign.left,
               // overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
