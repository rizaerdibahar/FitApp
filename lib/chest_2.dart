...
class chest_2 extends StatefulWidget {
  @override
  _chest_2State createState() => _chest_2State();
}

class _chest_2State extends State<chest_2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Chest1/Chest_expansion.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Really easy and effective way to train your chest.",
              ...
              Text(
                "   How to do it: Stand with your legs shoulder width apart. Open your arms to their extends making a single line form left arm to right arm. Bring them together without twisting your elbow in front of your chest and go back to starting position. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
