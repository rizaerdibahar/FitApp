...
class arm_4 extends StatefulWidget {
  @override
  _arm_4State createState() => _arm_4State();
}

class _arm_4State extends State<arm_4> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Arm1/Diamond_Pushup.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Like a classic pushup this exercise only differs how your hands positioned and excellent for you to train your arms.",
              ...
              Text(
                "   How to do it: Facing down the floor get into pushup position while placing your hands close together, keep your body straight and lower yourself until your chest is just above the floor and push back to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
