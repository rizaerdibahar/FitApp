...
class belly_4 extends StatefulWidget {
  @override
  _belly_4State createState() => _belly_4State();
}

class _belly_4State extends State<belly_4> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Belly1/Knee_to_elbow.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "An interesting way to exercise your abs , whole body and suprisingly your balancing.",
              ...
              Text(
                "   How to do it: Stand with your feet shoulder width apart. Touch side of your forehead with your hands, with your right pull your knee to your elbow, repat it for your left side.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
