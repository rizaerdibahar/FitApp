...
class leg_5 extends StatefulWidget {
  @override
  _leg_5State createState() => _leg_5State();
}

class _leg_5State extends State<leg_5> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Leg1/modified_scissors.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Lie down and enjoy this movement, it is fun to do!",
              ...
              Text(
                "   How to do it:  Lie down facing the ceiling, lift your legs up to make a v shape, bring your legs together and get them back to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
