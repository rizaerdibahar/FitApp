...
class chest_4 extends StatefulWidget {
  @override
  _chest_4State createState() => _chest_4State();
}

class _chest_4State extends State<chest_4> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Chest1/Push_Up.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Most basic way of training and perfect way to train your chest muscles.",
              ...
              Text(
                "   How to do it: Lie facing floor , make a straight line with your body. Push yourself with your arms to arms extend and lower to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
