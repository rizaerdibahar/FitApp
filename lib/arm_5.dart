...
class arm_5 extends StatefulWidget {
  @override
  _arm_5State createState() => _arm_5State();
}

class _arm_5State extends State<arm_5> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Arm1/Tricep_kickback_exercise.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "There will be miracles with dumbells and easy positioning , this exercise suited for your arms.",
              ...
              Text(
                "   How to do it:  Grab a set of dumbbells , lean forward and bend your knees. Bring your elbows up and kick back your arms until your arms are fully extended , reset your positioning.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
