...
class arm_2 extends StatefulWidget {
  @override
  _arm_2State createState() => _arm_2State();
}

class _arm_2State extends State<arm_2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Arm1/Upright_row.JPG',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "To train your arms simply pull back dumbbells while standing and you are good to go.",
