...
class back_3 extends StatefulWidget {
  @override
  _back_3State createState() => _back_3State();
}

class _back_3State extends State<back_3> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Spacer(flex: 2),
              Text(
                "Relief your back muscles with simple movements.",
              ...
              Text(
                "   How to do it: Stand still with your arms above your shoulder with natural width. Extend them straight and lower back to your starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
