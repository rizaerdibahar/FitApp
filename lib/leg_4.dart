...
class leg_4 extends StatefulWidget {
  @override
  _leg_4State createState() => _leg_4State();
}

class _leg_4State extends State<leg_4> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Leg1/Jump.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Everyday move is best for your legs.",
              ...
              Text(
                "   How to do it: Open your legs shoulder width , inhale and jump!",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
