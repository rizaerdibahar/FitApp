...
class shoulder_8 extends StatefulWidget {
  @override
  _shoulder_8State createState() => _shoulder_8State();
}

class _shoulder_8State extends State<shoulder_8> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Shoulder/Shoulder_taps.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "This exercise is like pushups with increased difficulty.",
              ...
              Text(
                "   How to do it:  Lie down facing the floor making a straight line. Starting with this position , reach out to your shoulder with opposite hand and repeat it for your other hand. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
