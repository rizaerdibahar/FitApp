...
class chest_5 extends StatefulWidget {
  @override
  _chest_5State createState() => _chest_5State();
}

class _chest_5State extends State<chest_5> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Chest1/Renegade_Row.JPG',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Positioning is a key factor fort his exercise , when done correctly it will train your chest and arms .",
              ...
              Text(
                "   How to do it:  Take dumbbells into your hand , facing down stand on your toes and dumbbells. Without losing your positioning one by one pull dumbbell to your chest and lower them to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
              ...
              Spacer(flex: 1),
              Text(
                "This exercise requires you to have dumbbells.",
                textAlign: TextAlign.left,
               // overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
