...
class back_6 extends StatefulWidget {
  @override
  _back_6State createState() => _back_6State();
}

class _back_6State extends State<back_6> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Back1/Knee_Roll.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Easy and fun way to train your back as well as your legs.",
              ...
              Text(
                "   How to do it: Lie on your back while pulling your knees to your belly. Put your hands on the floor and without distrupting this positioning move your knees to sides until respective side of knee hits the floor.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
