...
class belly_9 extends StatefulWidget {
  @override
  _belly_9State createState() => _belly_9State();
}

class _belly_9State extends State<belly_9> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Belly1/Sit_up.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "One of the basic exercises , this is ideal if you dont have many resources to do exercises.",
              ...
              Text(
                "   How to do it: Lie down while keeping your in a v shape.Put your hands back sides of your head. Without moving your lower body parts, push yourself towards your knees and get back to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
