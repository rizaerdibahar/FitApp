...
class arm_8 extends StatefulWidget {
  @override
  _arm_8State createState() => _arm_8State();
}

class _arm_8State extends State<arm_8> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Arm1/Front_arm_plank_reach_out.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "It is as easy as it sounds. Simply reach out and you will be trained.",
              ...
              Text(
                "   How to do it: Lay down facing down while standing on your arms. One by one simply reach out with your hands.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
