...
class belly_8 extends StatefulWidget {
  @override
  _belly_8State createState() => _belly_8State();
}

class _belly_8State extends State<belly_8> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Belly1/Side_plank_rotation.JPG',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "This exercise requires a mediocre difficulty positioning that will train your abs perfectly.",
              ...
              Text(
                "   How to do it: Starting on your side , your elbow directly under your shoulder place stack your feet.Lift your hips off the floor and make a diagonal line from your shoulder to feed , switch sides and repeat.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
