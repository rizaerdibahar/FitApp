...
class belly_2 extends StatefulWidget {
  @override
  _belly_2State createState() => _belly_2State();
}

class _belly_2State extends State<belly_2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Belly1/Crunches.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Very basic exercise that you will likely enjoy doing it after few tries.",
              ...
              Text(
                "   How to do it: Lie down facing upwards. Put your hand side of your head or under it. Twist your knees and pull your knees to you.Push your head as far as you can towards your knees and reset to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
