...
class leg_3 extends StatefulWidget {
  @override
  _leg_3State createState() => _leg_3State();
}

class _leg_3State extends State<leg_3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Leg1/Front_kick.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "You already done it before and just like before it is a simple kick to front.",
              ...
              Text(
                "   How to do it: Stand still , raise your knee. Thrusht your foot forward and lower your leg to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
