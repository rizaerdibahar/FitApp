...
class back_10 extends StatefulWidget {
  @override
  _back_10State createState() => _back_10State();
}

class _back_10State extends State<back_10> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Back1/Step_jacks.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Easy and fun exercise to do and train your back as well as your whole body.",
              ...
              Text(
                "   How to do it: Stand naturally, open your left leg to side and your arms to air , reset back to starting position , open your right leg to side and your arms to air.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
