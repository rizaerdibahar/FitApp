...
class chest_1 extends StatefulWidget {
  @override
  _chest_1State createState() => _chest_1State();
}

class _chest_1State extends State<chest_1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Chest1/Alt_Chest_Expansion.JPG',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
