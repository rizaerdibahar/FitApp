...
class shoulder_6 extends StatefulWidget {
  @override
  _shoulder_6State createState() => _shoulder_6State();
}

class _shoulder_6State extends State<shoulder_6> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Shoulder/Dumbbell_shoulder_press.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "This exercise is easy to position but may get hard to do as you increase the weight but offers to train your shoulders greatly.",
              ...
              Text(
                "   How to do it:  Get dumbbells to your hands. Stand your hands just above your shoulders.  Push both of your arms straight up and slowly lower yourself to starting position. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
