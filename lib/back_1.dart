        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Spacer(flex: 2),
              Text(
                "With the help of the machine you can easily do this exercise.",
              ...
              Text(
                "   How to do it: Place your thighs on the pad. Bend your knees slightly and secure your feet, keeping them in line with your knees. Extend your arms toward the floor.Move your upper body up and down.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
              ...
              Spacer(flex: 1),
              Text(
                "This exercise requires to have back extension machine.",
                textAlign: TextAlign.left,
               // overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
