...
class leg_9 extends StatefulWidget {
  @override
  _leg_9State createState() => _leg_9State();
}

class _leg_9State extends State<leg_9> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Leg1/Walking_lunge.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "This exercise can also be done with using dumbbells or own body weight and easy to train your legs.",
              ...
              Text(
                "   How to do it: Holding dumbells in each hand step forward with one leg and lower your body until your knee nearly touches to floor and slowly get up to your starting position. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
