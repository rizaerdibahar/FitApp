...
class leg_2 extends StatefulWidget {
  @override
  _leg_2State createState() => _leg_2State();
}

class _leg_2State extends State<leg_2> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Leg1/Flutter_kicks.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Easy and relaxing way to train your legs.",
              ...
              Text(
                "   How to do it: Lie down facing up, get your hands under your back to support them. Lift your legs and extend them to their reach one by one. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
