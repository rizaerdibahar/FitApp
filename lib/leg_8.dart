...
class leg_8 extends StatefulWidget {
  @override
  _leg_8State createState() => _leg_8State();
}

class _leg_8State extends State<leg_8> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Spacer(flex: 2),
              Text(
                "Basic move to train legs squat can be done using weight added bar or your own weight. Simply crouch and go back to standing stil and your training will be completed.",
              ...
              Text(
                "   How to do it: While standing take a deep breath and crouch and while lowering your knees try to push your knees out then return to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
              ...
              Spacer(flex: 1),
              Text(
                "This exercise dont have any requirements optionally with a barbell.",
                textAlign: TextAlign.left,
               // overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
