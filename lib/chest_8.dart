...
class chest_8 extends StatefulWidget {
  @override
  _chest_8State createState() => _chest_8State();
}

class _chest_8State extends State<chest_8> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Chest1/Arm_scissors.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Fun way to spend your time and train your chest.",
              ...
              Text(
                "   How to do it: Stand with your feets should width, open your arms to their extends to sides. Bring your arms to opposite sides just like scissors. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
