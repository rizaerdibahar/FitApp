...
class leg_1 extends StatefulWidget {
  @override
  _leg_1State createState() => _leg_1State();
}

class _leg_1State extends State<leg_1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Leg1/Calf_raise.JPG',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "This is a basic moves that trains your feet and legs with your own body weight.",
              ...
              Text(
                "   How to do it:  Stand straight with your legs shoulder width.Rise up to your toes ,pause for two seconds and go back to starting position. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
