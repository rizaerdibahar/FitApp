...
class leg_7 extends StatefulWidget {
  @override
  _leg_7State createState() => _leg_7State();
}

class _leg_7State extends State<leg_7> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Leg1/Side_leg_raise.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Relaxing positioning and a natural way to lie down this exercise is easy to do for anyone.",
              ...
              Text(
                "   How to do it: Lie down on your side , stack your legs and lift your leg up and down, change your lying side and repeat. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
