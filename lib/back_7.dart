...
class back_7 extends StatefulWidget {
  @override
  _back_7State createState() => _back_7State();
}

class _back_7State extends State<back_7> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Back1/Back_rotations.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Move your back slighlty to relax massively plus it is really easy to do.",
              ...
              Text(
                "   How to do it: Lie on your back , pull your knees to yourself. Without losing the positioning move your back to sides without too much effort. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
