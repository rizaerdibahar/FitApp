...
class belly_3 extends StatefulWidget {
  @override
  _belly_3State createState() => _belly_3State();
}

class _belly_3State extends State<belly_3> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Belly1/High_Knees.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Easy to position exercise but be carefull not to lose your balance.",
              ...
              Text(
                "   How to do it: While standing , keep your legs shoulder width apart. Raise your left leg by knee , lower it back and raise your right leg by knee.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
