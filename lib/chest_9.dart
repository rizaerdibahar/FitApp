...
class chest_9 extends StatefulWidget {
  @override
  _chest_9State createState() => _chest_9State();
}

class _chest_9State extends State<chest_9> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Chest1/Overhead_stretch.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "This exercise is one of the most natural way of humans flexing themselves.",
              ...
              Text(
                "   How to do it: Stand still , pull your elbow with opposite arm to flex yourself and after that with your fingers joint push upwards. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
