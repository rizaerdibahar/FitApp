...
class chest_7 extends StatefulWidget {
  @override
  _chest_7State createState() => _chest_7State();
}

class _chest_7State extends State<chest_7> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Chest1/Plyometric_pushup.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "More advanced way of doing pushups this exercise requires a great power to do but reward is even bigger than pushups.",
              ...
              Text(
                "   How to do it: Position yourself to pushup position, while doing pushups clap your hands mid air. ",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
