...
class arm_1 extends StatefulWidget {
  @override
  _arm_1State createState() => _arm_1State();
}

class _arm_1State extends State<arm_1> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Arm1/Biceps_curls.JPG',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Basic exercise to train your arm muscles without hard positioning or pressure on other muscels to train.",
              ...
              Text(
                "   How to do it: Stand whiel your feet apart from each other at hip-width. While your palms facing forward bend your elbows and lift dumbbells towards shoulders without moving upper arms and go lower dumbbells to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
