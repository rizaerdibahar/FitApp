...
class arm_10 extends StatefulWidget {
  @override
  _arm_10State createState() => _arm_10State();
}

class _arm_10State extends State<arm_10> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Arm1/Dumbbell_front_raise.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "Just stand stil and let your arms do the work, training your arms were never this easy!",
              ...
              Text(
                "   How to do it: Have dumbbells for your each hand, stand still.Raise your arms to maximum one by one  and slowly lower them to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
