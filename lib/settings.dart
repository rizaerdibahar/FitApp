...
import 'package:ilkflutterapp/s_change_email.dart';
          ...
          child: Column(
            ...
            children:<Widget>[
              ...
              child: Column(
                children: <Widget>[
              ListTile(
                leading: Icon(Icons.vpn_key, size: 16, color: Colors.purple),
                ...
                trailing: Icon(Icons.keyboard_arrow_right, size: 20, color: Colors.purple),
                  onTap:(){
                  ...
                  ListTile(
                    leading: Icon(Icons.alternate_email, size: 16, color: Colors.purple),
              ...
              Card(
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      leading: Icon(Icons.fingerprint, size: 16, color: Colors.purple),
                      title: Text(" Privacy",
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(fontWeight: FontWeight.bold,
                          fontSize: 14,
                    ...
                    SwitchListTile(
                      ...
                      title: RichText(
                        text: TextSpan(
                          children:[
                            WidgetSpan(
                              child: Icon(Icons.language, size: 16, color: Colors.purple),
                            ),
                            TextSpan(
                              text: "             Notifications",
                              style: TextStyle(fontWeight: FontWeight.bold,
