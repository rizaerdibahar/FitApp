...
class belly_10 extends StatefulWidget {
  @override
  _belly_10State createState() => _belly_10State();
}

class _belly_10State extends State<belly_10> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Belly1/Sitting_twist.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "A fun and effective way to train your abs and it is super easy.",
              ...
              Text(
                "   How to do it:Lie down with your knees forming a v shape. Pull your upper body to your knees to its natural extend.Keeping your hands touching and forming a straight line , twist right ,  go back to your starting position and twist left.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
