...
class belly_5 extends StatefulWidget {
  @override
  _belly_5State createState() => _belly_5State();
}

class _belly_5State extends State<belly_5> {
      ...
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage('images/Belly1/Leg_raise.jpg',),
                //width: 50,
                //height: 50,
              ),
              Spacer(flex: 2),
              Text(
                "A basic exercise with easy positioning that wil train your muscles.",
              ...
              Text(
                "   How to do it:Lie back with your hand by your head. Raise your feet up while keeping them together and keep your legs straight,if you can, or as much as you can raise your legs.Slowly return to starting position.",
                textAlign: TextAlign.left,
                //overflow: TextOverflow.ellipsis,
                style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
